...
Para evitar problemas posteriores se ha añadido un nuevo tipo de parámetro que permite indicar, además del valor, la categoría a la que pertenece el parámetro. En este momento se aceptan 3 categorias: _fieldName_ para indicar que el valor es el nombre de un campo, _fieldValue_ para indicar que el campo contenido en el parámetro debe convertirse a valor antes de ejecutar el cálculo y _literal_ para mandar cualquier otro valor. De este modo, los procesos automáticos de actualización podrán reconocer y cambiar cualquier actualización referida a un nombre de campo (ver el apartado [Configuración de cada nivel de extracción, en la descripción de los tipos de paràmetros para los calculadores](#configuraci%C3%B3n-de-cada-nivel-de-extracci%C3%B3n)). 
